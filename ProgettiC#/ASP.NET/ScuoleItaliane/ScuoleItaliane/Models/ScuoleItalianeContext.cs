...
public partial class ScuoleItalianeContext : DbContext
{
    ...
    public virtual DbSet<IstitutoRiferimento> IstitutoRiferimenti { get; set; }
    ...
    public virtual DbSet<TipologiaScuola> TipologiaScuole { get; set; }

    public virtual DbSet<ZonaAltimetrica> ZonaAltimetriche { get; set; }

    public virtual DbSet<ZonaMontana> ZonaMontane { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Provinci__3214EC07FB437996");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Regione__3214EC07C83E00BE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Ripartiz__3214EC07D21B150B");
        ...
        modelBuilder.Entity<Scuola>(entity =>
        {
            ...
            entity.HasOne(d => d.IdIstitutoRiferimentoNavigation).WithMany(p => p.Scuoli)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ZonaMont__3214EC07A1DFB2C2");
