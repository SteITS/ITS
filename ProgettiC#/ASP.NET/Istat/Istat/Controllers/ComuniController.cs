...
namespace Istat.Controllers
{
    public class ComuniController : Controller
    {
        ...
        public async Task<IActionResult> Index(string comune, int? popolazione)
        {
            ...
            {
                istat2015Context = istat2015Context.Where(c => c.Denominazione.Equals(comune));
            }
            if(popolazione != null)
            {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdZonaAltimetrica"] = new SelectList(_context.ZonaAltimetriche, "Id", "Id");
            ViewData["IdZonaMontana"] = new SelectList(_context.ZonaMontane, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdProvincia,Denominazione,CodiceCatastale,ComuneCapoluogo,AltitudineCentro,ZonaLitoranea,IdZonaAltimetrica,IdZonaMontana,Superficie,Popolazione2001,Popolazione2011")] Comune comune)
        {
            ...
            ViewData["IdZonaAltimetrica"] = new SelectList(_context.ZonaAltimetriche, "Id", "Id", comune.IdZonaAltimetrica);
            ViewData["IdZonaMontana"] = new SelectList(_context.ZonaMontane, "Id", "Id", comune.IdZonaMontana);
            return View(comune);
        }
