...
namespace BikeStores.Backend.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var lista = _context.Customers.IgnoreQueryFilters();
            return View(lista);
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            {
                customer = await _context.Customers.FirstOrDefaultAsync(p => p.Email.Equals(userMail));
            }
            return View(customer);
        }
        [Authorize(Roles = "Customers")]
        public async Task<IActionResult> DetailsProp(int? id)
        {
            var userMail = User.FindFirstValue(ClaimTypes.Email);
            var customer = await _context.Customers.FirstOrDefaultAsync(p => p.Email.Equals(userMail));
